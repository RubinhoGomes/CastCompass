...
--
-- Host: localhost:8889
-- Generation Time: Nov 25, 2024 at 11:39 PM
...
ALTER TABLE `produto`
  ...
  ADD CONSTRAINT `produto_ibfk_2` FOREIGN KEY (`imagemID`) REFERENCES `imagem` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
